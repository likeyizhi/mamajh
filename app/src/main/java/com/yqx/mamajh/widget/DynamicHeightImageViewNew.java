 ...
 */
public class DynamicHeightImageViewNew extends ImageView {

	private Context context;
    private double mHeightRatio = 1.0;

    public DynamicHeightImageViewNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public DynamicHeightImageViewNew(Context context) {
        super(context);
        this.context = context;
    }
