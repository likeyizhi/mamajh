package com.yqx.mamajh.widget.cyclebanner;
...
//			layout.setMargins(5, 0, 5, 0);
			layout.setMargins(imageParams, 0, imageParams, 0);
			...
			if (i == 0) {
				mImageViews[i].setBackgroundResource(R.drawable.tab_white_shape);
			} else {
				mImageViews[i].setBackgroundResource(R.drawable.tab_hui_shape);
			}
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			index -= 1;
			mImageViews[index].setBackgroundResource(R.drawable.tab_white_shape);
...
//				imageView.setLayoutParams(new LayoutParams(BaseApplication.getInstance().screen, (int) (BaseApplication.getInstance().screen*0.375+0.5f)));
				imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);//TODO 张杨
...
//			imageView.setTag(imageUrl);
			imageView.setTag(R.id.image_tag,imageUrl);
