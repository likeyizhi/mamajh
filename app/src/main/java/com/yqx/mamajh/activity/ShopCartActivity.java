...
public class ShopCartActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_settlement:
                ...
                String ids = "";
                //List<Cartlist.Shop> orderEntities = new ArrayList<>();
    ...
    private class ShopCartAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(final int i, boolean b, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.item_shop_cart_group, null);
                holder = new GroupViewHolder(view);
                view.setTag(holder);
            } else {
                holder = (GroupViewHolder) view.getTag();
            }
            Glide.with(getApplicationContext()).load(entity.getShopLogo()).crossFade().into(holder.ivItemPic);
...
//                    }
        ...
        public View getChildView(final int i, final int i1, boolean b, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.item_shop_cart_child, null);
...
//                        Toast.makeText(ShopCartActivity.this,checkNum+"d",Toast.LENGTH_SHORT).show();
                        if (checkNum==1){
...
//                        Toast.makeText(ShopCartActivity.this,checkNum+"w",Toast.LENGTH_SHORT).show();
                        if (checkNum>=0){
                            mEntities.get(i).setIsCheck(true);
                        }else{
                            mEntities.get(i).setIsCheck(false);
...
//                    mEntities.get(i).setIsCheck(holder.cbItemCheck.isChecked());
            ...
            holder.ivItemDel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new MaterialDialog.Builder(ShopCartActivity.this)
                            .title("是否删除")
