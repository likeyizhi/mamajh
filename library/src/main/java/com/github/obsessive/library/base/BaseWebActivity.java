...
//        setSystemBarTintDrawable(getResources().getDrawable(R.drawable.sr_primary));
        ...
        title = ButterKnife.findById(this, R.id.tv_toolbar);

        ImageButton leftBtn = ButterKnife.findById(this, R.id.ib_leftbtn);
        ImageButton rightBtn = ButterKnife.findById(this, R.id.ib_rightbtn);
