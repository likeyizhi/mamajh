package com.github.obsessive.library.widgets.switchbutton;
...
/**
 * Created by young on 2015/9/29.
 */
public class Configuration implements Cloneable {

	static class Default {
		static int DEFAULT_OFF_COLOR = Color.parseColor("#F1F1F1");
//		static int DEFAULT_ON_COLOR = Color.parseColor("#02BFE7");
//		static int DEFAULT_ON_COLOR = Color.parseColor("#0099FF");
		static int DEFAULT_ON_COLOR = Color.parseColor("#D4021A");
